...
Validates the full dispatch → expert compute → combine → TP all-reduce chain
for the AgRsAll2AllManager + CPUExpertsFp8 path on CPU (gloo backend).
...
# ---------------------------------------------------------------------------
# Shared helpers (mirrors test_cpu_quant_fused_moe.py)
# ---------------------------------------------------------------------------
